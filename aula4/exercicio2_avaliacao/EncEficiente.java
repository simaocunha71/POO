...
public class EncEficiente {
    ...
    /**
     * Construtor de acesso a EncEficiente dando todos os parametros
     ...
     */
    public EncEficiente (String nomeCliente, int nif, String morada, int numeroEncomenda, LocalDate data, ArrayList<LinhaEncomenda> encomendas ){
    ...
    /**
     * Construtor de acesso a EncEficiente
     */
    public EncEficiente (){
    ...
    /**
     * Construtor de acesso a EncEficiente dando uma outra EncEficiente
     * @param ec EncEficiente
     */
    public EncEficiente (EncEficiente ec){
